...
import com.study.dictionaryforkids.exercise.QuizAbjadActivity;
import com.study.dictionaryforkids.exercise.QuizAngkaActivity;
import com.study.dictionaryforkids.exercise.QuizAnimalsActivity;
import com.study.dictionaryforkids.exercise.QuizBuahActivity;
import com.study.dictionaryforkids.exercise.QuizKendaraanActivity;
...
public class QuizActivity extends AppCompatActivity {
    ...
    public void initListener(){
        btnAbjad.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(QuizActivity.this, QuizAbjadActivity.class);
        ...
        btnAngka.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(QuizActivity.this, QuizAngkaActivity.class);
                startActivity(intent);
                button.start();
            }
        });
        ...
        btnHewan.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(QuizActivity.this, QuizAnimalsActivity.class);
                startActivity(intent);
                button.start();
            }
        });
        ...
        btnKendaraan.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(QuizActivity.this, QuizKendaraanActivity.class);
                startActivity(intent);
                button.start();
            }
        });
        ...
        btnBuah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(QuizActivity.this, QuizBuahActivity.class);
                startActivity(intent);
                button.start();
            }
        });
