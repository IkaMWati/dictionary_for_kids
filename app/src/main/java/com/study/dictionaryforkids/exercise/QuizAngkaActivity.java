...
import com.study.dictionaryforkids.formula.Angka;

import java.util.Random;

public class QuizAngkaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.activity_quiz_angka);
    ...
    public void iscorrect(boolean input){
        ...
        if(i==n){
            Intent intent = new Intent(QuizAngkaActivity.this,
                    HasilActivity.class);
