...
import com.study.dictionaryforkids.formula.Kendaraan;

import java.util.Random;

public class QuizKendaraanActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.activity_quiz_kendaraan);
    ...
    public void iscorrect(boolean input){
        ...
        if(i==n){
            Intent intent = new Intent(QuizKendaraanActivity.this, HasilActivity.class);
